// AES-256-GCM at rest, key derived via PBKDF2 from a per-device secret
// (see secure-store.js) — not from a password, since workspaces don't
// have their own passwords. Everything stays local — no server, no
// network call.
